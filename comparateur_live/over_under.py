...
async def over_under_recuperation(a):
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=3.5,G=4,over_T=9,under_T=10)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=3,G=4,over_T=9,under_T=10)
    ...
    try:
        ...
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=2,G=4,over_T=9,under_T=10)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=1.5,G=4,over_T=9,under_T=10)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=1,G=4,over_T=9,under_T=10)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")

    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=0.5,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=4,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=4.5,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=5,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=5.5,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=6,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=6.5,G=4,over_T=9,under_T=10)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")

    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=7,G=4,over_T=9,under_T=10)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")

    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=7.5,G=4,over_T=9,under_T=10)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=0.75,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=1.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=1.75,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=2.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=2.75,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=3.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=3.75,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=4.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=4.75,G=1007,over_T=3827,under_T=3828)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")

    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=5.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=5.75,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=6.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=6.75,G=1007,over_T=3827,under_T=3828)

    except Exception as e :
        print(f"l erreur {e} est survenue lors de l execution de over_under_traitement")

    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=7.25,G=1007,over_T=3827,under_T=3828)
    ...
    try:
        await over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,goal=7.75,G=1007,over_T=3827,under_T=3828)
