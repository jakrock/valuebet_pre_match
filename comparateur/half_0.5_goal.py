...
async def over_under_recuperation(a):
    ...
    url = f"https://1xbet.mobi/LineFeed/GetGameZip?id={mg+1}&lng=fr&tzo=2&isSubGames=true&GroupEvents=true&countevents=250&grMode=2&country=182&marketType=1&mobi=true"
    try:
