...
async def match_odd_recuperation(a):
    ...
    url = f"https://1xbet.mobi/LineFeed/GetGameZip?id={Id}&lng=fr&tzo=2&isSubGames=true&GroupEvents=true&countevents=2000&grMode=2&country=182&marketType=1&mobi=true"
    try :
